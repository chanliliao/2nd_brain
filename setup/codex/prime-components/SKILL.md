...
3. Study feature components as examples:
   - `src/features/polls/components/create-poll-form.tsx` â€” Client Component using Server Action with `useActionState`
   - `src/features/polls/components/vote-form.tsx` â€” radio form with pending state via `useFormStatus`
   - `src/components/theme-toggle.tsx` â€” minimal Client Component example
